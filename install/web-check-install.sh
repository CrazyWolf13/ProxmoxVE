...
source /dev/stdin <<< "https://raw.githubusercontent.com/CrazyWolf13/ProxmoxVE/refs/heads/CrazyWolf13-add-web-check/misc/install.func"
color
verb_ip6
catch_errors
...
cat > /opt/start-web-check.sh << 'EOF'
#!/bin/bash
